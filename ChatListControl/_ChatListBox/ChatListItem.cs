...
namespace ChatListControl._ChatListBox
{
    public class ChatListItem
    {
        ...
        public class ChatListSubItemCollection : IList, ICollection, IEnumerable
        {
            ...
            public ChatListSubItem[] m_arrSubItems;
            ...
            private void EnsureSpace(int elements) {
                if (m_arrSubItems == null)
                    m_arrSubItems = new ChatListSubItem[Math.Max(elements, 1)];
            ...
            public void RemoveAt(int index) {
                ...
                ChatListSubItem[] arrTempSubItem = new ChatListSubItem[count];
                Array.Copy(m_arrSubItems, arrTempSubItem, count);
                m_arrSubItems = arrTempSubItem;
                if (this.owner.OwnerChatListBox != null)
                    this.owner.OwnerChatListBox.Invalidate();
            }
            /// <summary>
            ...
            public ChatListSubItem this[string NicName]
            {
                get
                {
                  var result=  m_arrSubItems.Where(a => a != null && a.NicName == NicName);
                  if (result.Count() == 0)
                  {
                      return null;
                  }
