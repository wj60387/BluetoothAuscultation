...
namespace WeifenLuo.WinFormsUI.Docking
{
    internal class VS2005DockPaneStrip : DockPaneStripBase
    {
        ...
        private const int _ToolWindowImageGapTop = 13;
        ...
        private const int _DocumentStripGapBottom = 2;
        ...
        private const int _DocumentTabGapTop =  4;
        private const int _DocumentTabGapLeft = 3;
        private const int _DocumentTabGapRight = 3;
        private const int _DocumentIconGapBottom = 4;
